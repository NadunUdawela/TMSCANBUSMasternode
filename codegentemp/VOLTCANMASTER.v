// ======================================================================
// VOLTCANMASTER.v generated from TopDesign.cysch
// 05/31/2022 at 13:16
...
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("91b4bb0f-23fe-4cb5-910c-b3efec1f1cf6/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("91b4bb0f-23fe-4cb5-910c-b3efec1f1cf6/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("6250000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a17c9be4-fd42-4755-be90-d481a152b4f6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d3463521-0344-4e34-86b9-cc29ea3619ce"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9a7e0af5-607e-4209-b98f-079de911c4fb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e1a10d06-4369-4fac-9bca-b05d6ec9d1c8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1c2067dc-77dc-42ac-b980-6fc809fdd872"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("308f817f-4ab4-4339-a0d0-c8991f03aea8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("73504a17-134f-4da7-aa91-bb66014e6010"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("3dd1c3cd-4505-424b-92cb-efe3d075b1ff"),
		  .source_clock_id(""),
		  .divisor(0),

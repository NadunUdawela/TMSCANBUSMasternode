...
//extern uint16 TX_DATA[3];
extern uint8 TX_DATA8[3];
extern uint16 RX_DATA_P1[3];
/* `#END` */
    ...
    uint8 CAN_1_SendMsg0(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                //CAN_1_TX_DATA_BYTE1(0) = (TX_DATA[0] >> 0) & 0xFF;
                //CAN_1_TX_DATA_BYTE2(0) = (TX_DATA[0] >> 8) & 0xFF;
                //CAN_1_TX_DATA_BYTE3(0) = (TX_DATA[1] >> 0) & 0xFF;
                //CAN_1_TX_DATA_BYTE4(0) = (TX_DATA[1] >> 8) & 0xFF;
                //CAN_1_TX_DATA_BYTE5(0) = (TX_DATA[2] >> 0) & 0xFF;
                //CAN_1_TX_DATA_BYTE6(0) = (TX_DATA[2] >> 8) & 0xFF;
                
                CAN_1_TX_DATA_BYTE1(0) = 0x00;
                CAN_1_TX_DATA_BYTE2(0) = 0xF3;
                CAN_1_TX_DATA_BYTE3(0) = 0x00;
                CAN_1_TX_DATA_BYTE4(0) = 0x80;
                CAN_1_TX_DATA_BYTE5(0) = 0xF3;
                CAN_1_TX_DATA_BYTE6(0) = 0x40;
                CAN_1_TX_DATA_BYTE7(0) = 0x1E;
                CAN_1_TX_DATA_BYTE8(0) = 0x90;
                /* `#END` */
    ...
    uint8 CAN_1_SendMsg1(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                CAN_1_TX_DATA_BYTE1(1) = 0x00;
                CAN_1_TX_DATA_BYTE2(1) = (TX_DATA8[1]) & 0xFF;
                CAN_1_TX_DATA_BYTE3(1) = (TX_DATA8[0]) & 0xFF;
                CAN_1_TX_DATA_BYTE4(1) = (TX_DATA8[2]) & 0xFF;
                CAN_1_TX_DATA_BYTE5(1) = 0x01;
                CAN_1_TX_DATA_BYTE6(1) = 0x01;
                CAN_1_TX_DATA_BYTE7(1) = 0x00;
                CAN_1_TX_DATA_BYTE8(1) = CAN_1_TX_DATA_BYTE1(1) + CAN_1_TX_DATA_BYTE2(1) + CAN_1_TX_DATA_BYTE3(1) + CAN_1_TX_DATA_BYTE4(1) + CAN_1_TX_DATA_BYTE5(1) + CAN_1_TX_DATA_BYTE6(1) + CAN_1_TX_DATA_BYTE7(1) + 0x39 + 0x08;
                /* `#END` */
    ...
    uint8 CAN_1_SendMsg2(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                CAN_1_TX_DATA_BYTE1(2) = 0x00;
                CAN_1_TX_DATA_BYTE2(2) = 0x00;
                CAN_1_TX_DATA_BYTE3(2) = 0x00;
                CAN_1_TX_DATA_BYTE4(2) = 0x00;
                CAN_1_TX_DATA_BYTE5(2) = 0x00;
                CAN_1_TX_DATA_BYTE6(2) = 0x00;
                CAN_1_TX_DATA_BYTE7(2) = 0x00;
                CAN_1_TX_DATA_BYTE8(2) = 0x00;
                /* `#END` */
    ...
    *******************************************************************************/
    void CAN_1_ReceiveMsg0(void) 
    {
        /* `#START MESSAGE_0_RECEIVED` */
                RX_DATA_P1[0] = CAN_1_RX_DATA_BYTE2(0);
                RX_DATA_P1[0] = (RX_DATA_P1[0] << 8) | CAN_1_RX_DATA_BYTE1(0);
                RX_DATA_P1[1] = CAN_1_RX_DATA_BYTE4(0);
                RX_DATA_P1[1] = (RX_DATA_P1[1] << 8) | CAN_1_RX_DATA_BYTE3(0);
                RX_DATA_P1[2] = CAN_1_RX_DATA_BYTE6(0);
                RX_DATA_P1[2] = (RX_DATA_P1[2] << 8) | CAN_1_RX_DATA_BYTE5(0);
        /* `#END` */
